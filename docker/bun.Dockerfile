...
# один на всіх.
# Версія закріплена точно, і це не педантизм: `1-alpine` на Hub сьогодні
# означає 1.4.2, а в локальному кеші лежав 1.3.14 — `docker build` без
# `--pull` бере кеш, тож дві машини зібрали б різні образи з того самого
# Dockerfile. Піднімати версію — окремим комітом, разом із bun на машинах.
