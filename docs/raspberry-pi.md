...
бонусів**, яка мовчки обіцяє те, чого без ws не буде. Тому після двох
хвилин без каналу на місці плашки «оновлення» зʼявляється
«Бонуси тимчасово недоступні» (`WS_OFFLINE_GRACE_S`, `WS_OFFLINE_LABEL`).
Дві хвилини — бо ws перепідключається за секунди, і блимати попередженням
на кожен розрив гірше, ніж мовчати.
