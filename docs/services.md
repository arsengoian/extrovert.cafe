...
| `extrovert-uploads` | **фото, які надсилає гравець у скарзі** | телефон гравця за підписаним посиланням | адмінка за підписаним посиланням | 90 днів (питання в `questions.md`) |
...
гравець: інший строк зберігання, інше право на видалення й інший шлях
...
```
bun run up                      # postgres + redis (порти 5442 / 6389)
