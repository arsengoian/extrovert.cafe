...
| `admin` | **заглушка**: лічильники з бази й перелік майбутніх розділів. Існує, щоб стек збирався й викочувався цілком; назовні не виходить — лише тунелем (`deploy.md` §2.3) |
