...
| сіди контенту (`db/seeds`) | описано (`db-schema.md` §7): JSON на таблицю, `pull` і `apply` по оточеннях. Є `item_defs.json` (75 предметів, прототипи описів); інструмента ще немає |
