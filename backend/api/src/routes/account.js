...
// покупок тримається вся аналітика точки й економіки, а угоди на маркеті
...
export default async function routes(app) {
  ...
  app.get("/me/deletion", async (req, reply) => {
    ...
    return {
      ...counts,
      // Не обіцяємо того, чого не робимо: сказати «зітремо все» й лишити
      // рядок у базі було б брехнею просто в інтерфейсі.
      keeps: [
