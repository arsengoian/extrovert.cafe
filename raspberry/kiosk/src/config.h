 ...
 * main.c блокувала всі наступні. 10 с, а не 4, як у тимчасового попапа: у
 * фінальному є QR («проскануй або сфотографуй»), і людині треба встигнути
 * дістати телефон. Бонус не зникає разом із попапом — він ще 2 хв у панелі. */
