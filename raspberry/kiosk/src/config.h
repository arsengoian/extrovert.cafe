 ...
 *
 * Дві хвилини витримки: ws перепідключається за секунди, і блимати
 * попередженням на кожен розрив — гірше, ніж мовчати. */
#define WS_OFFLINE_GRACE_S 120.0
#define WS_OFFLINE_LABEL "Бонуси тимчасово недоступні"
